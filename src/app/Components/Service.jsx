    ...
    return (
        <div id='service' className='relative py-12 lg:pt-[73px] lg:pb-10 '>
            <div className='container max-w-[1140px] 2xl:max-w-[1550px] mx-auto px-5  '>
                    ...
                    <Image className='absolute top-[4%] min-[1400px]:top-[-10%] right-0 hidden lg:block z-[-1] ' src={astroImg} alt="img" />
                ...
                <div className='relative '>
                    <h1 className='max-[400px]:text-[30px] text-[60px] lg:text-[70px] font-normal text-white sm:mb-5 lg:mb-0  '>Services...</h1>
                    <div className='absolute top-[55px] z-[-1] lg:top-[70px] left-[226px] md:left-[28%]  '>
                        <SpringBorder />
                    </div>
                </div>
                <div className='flex flex-wrap  sm:mx-5 lg:mx-10 '>
                    {ServiceArr.map((item, i) => {
                        return (
                          <div
                            key={i}
                            className="w-full sm:w-6/12 sm:px-[10px] lg:px-5 mt-5"
                          >
                            <div className="max-[400px]:p-0 p-[15px_20px] lg:p-[30px_40px] h-full border-b border-[#FFFFFF66">
                              <h1 className="max-[400px]:text-5xl  text-[60px] lg:text-[70px] font-normal text-white/80 ff_roadRage mb-2 xl:mb-5  leading-[50px] lg:leading-[77px] ">
                                {item.num}{" "}
                              </h1>
