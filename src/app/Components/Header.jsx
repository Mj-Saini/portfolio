            ...
            <div className='container max-w-[1140px] 2xl:max-w-[1550px] mx-auto px-5'>
                <div className='pt-[34px] pb-9 flex items-center justify-between'>
                    <div className='w-3/12 min-[1130px]:w-2/12'>
                        <a className='text-[32px] font-normal text-white ' href="">Vikas Boora</a>
                    </div>
                    ...
                    <div onClick={toggleNavBar()} className='w-8 h-7 flex flex-col justify-between duration-[5s] menu_bar min-[850px]:hidden '>
                    ...
                    <div className="md:hidden z-50" onClick={shownav}>
                        {navbar ? (<img className="h-6 w-6 rotate-[45deg]" src="" alt="img" />) : (<img className="h-6 w-6" src="" alt="img" />)}
                    </div>
                </div>
