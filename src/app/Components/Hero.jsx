...
const Hero = () => {
  return (
    <div className="min-h-screen">
            ...
            <div className="w-full mt-4 md:mt-0 md:w-1/2 text-center sm:text-start ">
              ...
              <div className="flex max-[420px]:flex-col gap-5 lg:gap-[29px] justify-center sm:justify-start  ">
                <button className=" border border-[#15FFEA] p-[10px] min-[850px]:p-[10px_20px] flex items-center justify-center gap-1 min-[850px]:gap-[10px] rounded-[50px] max-sm:w-[200px] max-[460px]:m-auto ">
                  <p className="text-center uppercase text-[#15FFEA] text-sm min-[850px]:text-base ">Download cv</p>
      ...
      <div className="container max-w-[1140px] 2xl:max-w-[1550px] mx-auto px-5 pt-10 md:pt-[70px] " >
        <div className="w-full lg:w-[90%] m-auto flex flex-wrap gap-5 md:gap-16  lg:gap-[100px] justify-center sm:justify-between md:justify-center ">
          {HeroSecArr.map((item, i) => {
            return (
              <div key={i} className="max-sm:w-4/12 w-2/12 flex gap-[15px] items-center" >
                <h1 className=" ff_roadRage text-5xl lg:text-[64px] font-normal text-[#FFFFFFCC] "> {item.numVal} </h1>
                <p className="text-sm lg:text-lg font-normal text-[#FFFFFFCC] "> {item.text} </p>
              </div>
            )
          })}
        </div>
