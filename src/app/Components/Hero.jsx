...
import myPic from "../../../public/assets/images/png/my-pic.jpeg";
import {
  DownloadIcon,
  GithubIcon,
  HeroSecElp,
          ...
          <div className="w-full mt-4 md:mt-0 md:w-1/2 text-center sm:text-start ">
            <div>
              ...
              <h1 className="font-semibold text-4xl md:text-[54px] lg:text-7xl xl:text-[80px] text-white md:!leading-[50px] lg:!leading-[90px] mt-1">
                Hello I’ m <span className="text-[#15FFEA]">Manoj Saini</span>
              </h1>
            ...
            <div className="flex max-[420px]:flex-col gap-5 lg:gap-[29px] justify-center sm:justify-start  ">
              <Link target="_blank" href="/assets/pdf/its-my-resume.pdf" download className=" border border-[#15FFEA] p-[10px] min-[850px]:p-[10px_20px] flex items-center justify-center gap-1 min-[850px]:gap-[10px] rounded-[50px] max-sm:w-[200px] max-[460px]:m-auto duration-300 hover:duration-300 hover:bg-[#15FFEA]  group ">
              ...
              <div className="flex max-sm:justify-center gap-2 lg:gap-5">
                <a target="_blank" href="https://github.com/Mj-Saini">
                ...
                <a target="_blank" href="https://www.linkedin.com/in/saini-mj/">
                  <span className="border border-[#15FFEA] rounded-[50px]  flex justify-center items-center w-10 h-10 duration-500 hover:-translate-y-3 hover:bg-[#15FFEA] socialHover ">
                    <LinkdinIcon />
                  </span>
                </a>
